...
double Dihotomia(double a, double b, double eps, double x1, double x2)
{
	double x, y, d = 0.0001;
	int N = 100000;
	int i = 0;
...
void Newton(double x1, double x2, double delta, double eps, int N, double a, double b)
{
...
//		alpha = Dihotomia(a, b, delta, x1, x2);
